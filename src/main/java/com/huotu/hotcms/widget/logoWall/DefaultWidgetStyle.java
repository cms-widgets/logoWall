...
public class DefaultWidgetStyle implements WidgetStyle{
    ...
    @Override
    public String id() {
        return "logoWallDefaultStyle";
    }

    @Override
    public String name() {
        return "bootstrap 风格logo墙";
    }
    ...
    public String name(Locale locale) {
        ...
        return "bootstrap style logoWall";
    }

    @Override
    public String description() {
        return "基于bootstrap样式的logo墙";
    }
    ...
    public String description(Locale locale) {
        ...
        return "Based on the bootstrap style by logoWall";
    }
